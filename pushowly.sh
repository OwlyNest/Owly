#!/bin/bash
echo "[x] Pushing Owly"
# pushowly.sh – Pushes Owly to GitHub
REPO_URL="https://github.com/OwlyNest/Owly.git"

#Extract version info
VERSION="v3.0.0-pre-pre"
COMMIT_MSG=${*:-"Update on: Owly version $VERSION"}
